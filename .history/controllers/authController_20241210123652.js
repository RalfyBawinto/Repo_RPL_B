...
export const loginUser = async (req, res) => {
    ...
    try {
        ...
        // Periksa apakah password yang dimasukkan cocok dengan hash yang tersimpan
        const isPasswordValid = await bcrypt.compare(password, user.password);
        console.log('Is password valid:', isPasswordValid);  // Pastikan ini menunjukkan `true` jika cocok
