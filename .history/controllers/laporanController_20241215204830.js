import LaporanKerusakan from "../models/laporanKerusakanModel.js"; // Pastikan import model dengan benar
import multer from "multer";
import path from "path";
import { io } from "../index.js"; // Pastikan io sudah diinisialisasi dengan benar
...
export const createLaporan = (req, res) => {
  ...
  upload.single("gambar")(req, res, async (err) => {
    ...
    try {
      ...
      // Kirim notifikasi ke klien menggunakan Socket.io
      io.emit("laporan_terkirim", { laporan: newLaporan });
